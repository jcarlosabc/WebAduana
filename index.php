              ...
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-left">
                    <p>Información</p>
                    <h5>Imagen</h5>
                    <a href="about.php" class="btn btn-white">Leer mas</a>
                  </div>
                </div>
              </div>
              <!-- <div class="banhny-w3grids">
                <div class="banhny-w3grids-1">
                  <img src="assets/images/bannerMackup.jpg" class="img-curve img-fluid" alt="" />
      ...
      <div class="container py-md-5">
        <div class="cwp4-two row">
          <div class="cwp4-image col-lg-6 pr-lg-5 mb-lg-0 mb-5">
            <img src="assets/images/bannerMackup.jpg" class="img-fluid" alt="" />
          </div>
          <div class="cwp4-text col-lg-6">
            <!-- <h6 class="sub-title">what We Do</h6> -->
            <h3 class="hny-title">Servicios</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicingelit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua.
            </p>
            <ul class="cont-4">
              <li><span class="fa fa-check"></span> Servicio #1</li>
              <li><span class="fa fa-check"></span> Servicio #2</li>
              <li><span class="fa fa-check"></span> Servicio #3</li>
              <li><span class="fa fa-check"></span> Servicio #4</li>
              <li><span class="fa fa-check"></span> Servicio #5</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="container py-md-5">
      <div class="row bottom-ab-grids align-items-center">
        <div class="col-lg-6 bottom-ab-left pr-lg-5">
          <!-- <h6 class="sub-title">Asesorías y consultorías</h6> -->
          <h3 class="hny-title">Asesorías y consultorías</h3>
          <p class="my-3 pr-lg-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur hic odio
            ...
            <ul class="cont-4">
              <li><span class="fa fa-check"></span> Tema #1</li>
              <li><span class="fa fa-check"></span> Tema #2</li>
              <li><span class="fa fa-check"></span> Tema #3</li>
              <li><span class="fa fa-check"></span> Tema #4</li>
              <li><span class="fa fa-check"></span> Tema #5</li>
            </ul>
  ...
  <section class="w3l-how-grids-3 py-5" id="how">
    <div class="container py-md-5">
      <div class="w3l-header mb-md-5 mb-4">
        ...
        <h3 class="hny-title">Otros temas para <br> Agregar</h3>
      ...
      <div class="row bottom-ab-grids align-items-center">
        <div class="col-lg-4 bottom-ab-left">
          <div class="grdhny-info">
            <img src="assets/images/bannerMackup.jpg" class="img-curve img-fluid" alt="" />
            <h4><a href="#" class="hnys-title">Punto #1</a></h4>
        ...
        <div class="col-lg-4 bottom-ab-right my-lg-0 my-5">
          <div class="grdhny-info">
            <img src="assets/images/bannerMackup.jpg" class="img-curve img-fluid" alt="" />
            <h4><a href="#" class="hnys-title">Punto #2</a></h4>
            <p class="mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur hic odio voluptatem
              tenetur consequatur.</p>
          </div>
        </div>
        <div class="col-lg-4 bottom-ab-right">
          <div class="grdhny-info">
            <img src="assets/images/bannerMackup.jpg" class="img-curve img-fluid" alt="" />
            <h4><a href="#" class="hnys-title">Punto #3</a></h4>
            <p class="mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur hic odio voluptatem
              tenetur consequatur.</p>
          </div>
        </div>
